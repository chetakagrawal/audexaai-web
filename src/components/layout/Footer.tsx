    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-xl font-bold text-white mb-4">
              Audexa <span className="text-primary-400">AI</span>
            </h3>
            <p className="text-sm text-gray-400">
              AI-powered SOX audit validation for enterprise teams.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#solution" className="hover:text-primary-400 transition">Solution</a></li>
              <li><a href="#how-it-works" className="hover:text-primary-400 transition">How It Works</a></li>
              <li><a href="#security" className="hover:text-primary-400 transition">Security</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-400 transition">SOC2 Compliance</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Audexa AI. All rights reserved.
          </p>
